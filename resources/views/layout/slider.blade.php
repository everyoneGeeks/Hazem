        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item ">
              ...
              <!-- users Route-->  
              <li class="nav-item ">
              <a href="/admin/portfolios" class="nav-link {{ Request::is(Route::currentRouteName() == 'portfolios') ? 'active' : '' }}">
                <i class="nav-icon  fa  fa-book" aria-hidden="true"></i>
                <p>
                portfolios
                </p>
                          ...
                          <!-- users Route-->  
              <li class="nav-item ">
              <a href="/admin/testimonials" class="nav-link {{ Request::is(Route::currentRouteName() == 'testimonials') ? 'active' : '' }}">
                <i class="nav-icon  fa  fa-book" aria-hidden="true"></i>
                <p>
                Testimonials
                </p>
                                      ...
                                      <!-- users Route-->  
                                      <li class="nav-item ">
              <a href="/admin/teams" class="nav-link {{ Request::is(Route::currentRouteName() == 'teams') ? 'active' : '' }}">
                <i class="nav-icon  fa  fa-book" aria-hidden="true"></i>
                <p>
                teams
                </p>
